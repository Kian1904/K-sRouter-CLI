...
const DEFAULT_TIMEOUT_MS = 60000; // 60 detik — memberi waktu aman untuk task coding/plan LLM
 ...
 * @param {Object} [options={}] - Konfigurasi tambahan: { skipMemory, timeout, effort }
 */
export async function sendChatRequest(backendUrl, messages, options = {}) {
  ...
  // Inject memory context ke system message (KECUALI jika mode agent ketat atau skipMemory=true)
