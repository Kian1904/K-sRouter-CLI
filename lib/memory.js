...
export async function buildMemoryContext(projectName) {
  ...
  // IDENTITY FRAMING — wajib ada di awal biar AI gak salah interpretasi
...
export async function clearLearningMemory() {
  ...
  await fetch(`${SUPABASE_URL}/rest/v1/agent_learning?id=gt.0`, {
    method: "DELETE",
    headers: {
      apikey: SUPABASE_KEY,
      Authorization: "Bearer " + SUPABASE_KEY
...
export async function clearDecisionMemory() {
  ...
  await fetch(`${SUPABASE_URL}/rest/v1/agent_decisions?id=gt.0`, {
    method: "DELETE",
    headers: {
      apikey: SUPABASE_KEY,
      Authorization: "Bearer " + SUPABASE_KEY
...
export async function clearProjectMemory() {
  ...
  await fetch(`${SUPABASE_URL}/rest/v1/agent_projects?id=gt.0`, {
    method: "DELETE",
    headers: {
      apikey: SUPABASE_KEY,
      Authorization: "Bearer " + SUPABASE_KEY
